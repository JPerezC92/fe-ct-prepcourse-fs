...
function eliminarPropiedad(objeto, propiedad) {
  ...
  return Object.fromEntries(
    Object.entries(objeto).filter(([key, value]) => key !== propiedad)
  );
}
...
function agregarAmigo(objetoUsuario, nuevoAmigo) {
  ...
  return { ...objetoUsuario, amigos: [...objetoUsuario.amigos, nuevoAmigo] };
}
...
function sumarLikesDeUsuario(objetoUsuario) {
  ...
  return objetoUsuario.posts.reduce((acum, curr) => acum + curr.likes, 0);
}
